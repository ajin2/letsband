	...
	<table border="1" align="center" style="width:95%; height:95%;"> 
		<tr style="height:50px;">
         <td align="center" colspan="2">
            <input type="image" src="${img}ama.jpg" style="height:40px; width:130px;" 
            onclick="location='BandBoard_youtube.do'"> &nbsp;&nbsp;&nbsp;
            <input type="image" src="${img}pro.jpg" style="height:40px; width:160px;" 
            onclick="location='BandBoard_proyoutube.do'">
         </td>
      </tr>
